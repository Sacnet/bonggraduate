...
<div class="container-fluid">
    <div class="row">
     ...
     <?php echo '<img src="file/'.Session::get('picture').'" style="margin-top:-14%; width:90px; height:90px; border-radius:45px 45px 45px 45px; margin-left:60%"/>'; ?>
         ...
         <ul>
             ...
             <li><a href="cxtam.php">Create Member Login Account</a></li>
    ...
    <div class="plateacc">
        ...
        <h3 style="padding-top:2rem; text-shadow: .1rem .1rem .5rem black;">Member Login Account Form</h3>
...
<form action="" method="POST">
    ...
    <div>
        <input type="submit" id="memUser" class="btn btn-primary" value='Create' style="width:100%; height:33px; margin-top:5px;">
    </div>
</form>
    </div>
    </div>

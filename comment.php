...
<div class="container-fluid">
    ...
    <div class="plateuser">
        ...
        <h3 style="padding-top:2rem; text-shadow: .1rem .1rem .5rem black;">Message from Contact</h3>
        ...
        <hr>
            ...
            ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $result['memtype'];?></td>
                            <td><?php echo $result['email'];?></td>
                            <td><?php echo ($result['messag']);
